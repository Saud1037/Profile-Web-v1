      ...
      >
        ...
        <div className="bg-[var(--bg-secondary)] border border-[var(--border-2)] rounded-2xl p-10">
          ...
          <div className="text-center mb-8">
            ...
            <h1 className="text-xl font-semibold text-[var(--text)]">لوحة التحكم</h1>
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            <div>
              <label className="font-mono text-xs text-[var(--cyan)] block mb-2 uppercase" style={{ letterSpacing: '0.05em' }}>
                كلمة المرور
              </label>
              <input
                type="password"
            ...
            {error && (
              <motion.p
                ...
                className="font-mono text-xs text-[var(--red)] text-center"
              >
                {error}
              </motion.p>
            )}
          ...
          <div className="mt-6 text-center">
            <a
              href="/"
              className="font-mono text-xs text-[var(--text-3)] hover:text-[var(--cyan)] transition-colors"
            >
              ← العودة للموقع
            </a>
          </div>
