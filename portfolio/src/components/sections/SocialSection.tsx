...
export function SocialSection({ socialLinks }: { socialLinks: SocialLink[] }) {
  return (
    <section id="section-social" className="relative z-10 max-w-6xl mx-auto px-6 py-10 pb-20">
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        {socialLinks.map((link, i) => (
          ...
          >
            <div className="w-10 h-10 rounded-lg flex items-center justify-center text-xl flex-shrink-0" style={{ background: `${link.color}22` }}>
              {link.icon}
            </div>
            <div>
