  ...
  return (
    <div ref={ref} className="h-0.5 bg-[var(--bg-tertiary)] rounded-full overflow-hidden">
      <div
        ...
        style={{ width: `${width}%`, background: 'linear-gradient(90deg, var(--cyan), var(--purple))' }}
      />
    </div>
  )
}
  ...
  return (
    <section id="section-skills" className="relative z-10 max-w-6xl mx-auto px-6 py-20">
      <div className="flex items-center gap-4 mb-12">
        ...
        <h2 className="text-3xl font-bold text-[var(--text)]">Skills</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
        {skillGroups.map((group, gi) => (
          ...
          >
            <h3 className="font-mono text-xs text-[var(--cyan)] mb-5 uppercase" style={{ letterSpacing: '0.1em' }}>
              {group.group_name}
            </h3>
